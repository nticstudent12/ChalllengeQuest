...
import { Crown, Trophy, Medal, Award, Zap, Loader2 } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Compete with the best challengers worldwide and claim your spot at the top
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {globalLeaderboard.slice(0, 3).map((player, index) => {
            ...
            return (
              <div
                key={playerData.rank}
                className={`glass-card rounded-xl p-6 border-2 ${getRankClass(playerData.rank)} ${playerData.rank === 1 ? "md:-mt-4" : "md:mt-4"}`}
              >
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold mb-2">{playerData.username}</h3>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-bold text-lg">{playerData.completedChallenges}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <Tabs defaultValue="all" className="space-y-6">
          ...
          <TabsContent value="all" className="space-y-3">
            {globalLeaderboard.slice(3).map((player) => (
              <Card key={player.rank} className="glass-card border-border/50 hover:border-primary/30 transition-all duration-300">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-8 text-sm">
                      ...
                      <div className="text-center hidden md:block">
                        <p className="text-muted-foreground">Completed</p>
                        <p className="font-bold">{player.completedChallenges}</p>
                      </div>
                      <div className="text-center">
